...
type GetConvMessageListRequest struct {
	DeviceID       string `json:"device_id" form:"device_id" param:"device_id" query:"device_id"`
...
type InfoRequest struct {
	...
	Gender   string `json:"gender" validate:"omitempty,oneof=未知 男 女" msg:"oneof:性别取值范围为[未知,男,女]"`
